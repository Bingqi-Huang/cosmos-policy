...
def script_for_run(run: dict[str, Any], common: dict[str, Any]) -> str:
    ...
    env = {
        ...
        "LR": run.get("optimizer_lr", common["optimizer_lr"]),
        "EMA_ENABLED": run.get("ema_enabled", common["ema_enabled"]),
        "LOAD_EMA_TO_REG": run.get("load_ema_to_reg", common["load_ema_to_reg"]),
