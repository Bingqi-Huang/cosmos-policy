...
# Generated from phase3_run_registry.json for a5_independent_noise_default_seed43.
...
export JOB_NAME=phase3_a5_ind_noise_default_lambda010_seed43
export LAMBDA_CV=0.1
export CV_FRAME_SET=action+value+fproprio
export CV_NOISE_SHARED=false
